package uy.com.abitab.iddigitalsdk.presentation.qr_validation.ui
...
import uy.com.abitab.iddigitalsdk.presentation.qr_validation.ui.screens.QrValidationFlow
...
class QrValidationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            QrValidationFlow(challengeType = challengeType, context = context, onClose = {
                finish()
            })
        }
    }
    ...
    companion object {
        ...
        fun createIntent(
            ...
            return Intent(context, QrValidationActivity::class.java).apply {
